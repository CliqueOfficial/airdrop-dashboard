          ...
          <div class="flex items-center justify-between h-16">
            ...
            <div class="flex items-center gap-8">
              <div class="flex items-center gap-3">
                <div class="relative">
                  <div class="w-9 h-9 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-lg flex items-center justify-center shadow-sm transform hover:scale-110 transition-transform">
                    <span class="text-xl">🪂</span>
                  </div>
                </div>
                <span class="text-gray-900 font-bold text-xl tracking-tight">Airdrop Dashboard</span>
              </div>
