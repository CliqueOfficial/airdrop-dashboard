...
export const Dashboard = () => {
    ...
    const [appConfs] = createResource(() => config.baseUrl, async (baseUrl: string) => {
    ...
    const deployements = (appId: string) => appConfs.loading ? {} : appConfs().find((appConf: any) => appConf.appId === appId)?.deployments;
    ...
    return (
        <section class="bg-gray-100 text-gray-700 p-8">
            <div>
                ...
                <select id="app-select" class="inline ml-4 border-b border-gray-300  p-1" value={config.currentAppId} onChange={(e) => setCurrentAppId(e.target.value)}>
